...
__used __section("__versions") = {
	...
	{ 0x6de2d276, "prepare_sleep_cmd" },
	{ 0x958d26ac, "convert_table_to_blob" },
	{ 0x7bd9e57c, "tegracam_get_privdata" },
	{ 0x3c3ff9fd, "sprintf" },
	{ 0x28257cd9, "conv_u16_u8arr" },
	{ 0x3ea1b6e4, "__stack_chk_fail" },
	{ 0x524af084, "prepare_write_cmd" },
	{ 0x1fdc7df2, "_mcount" },
};

MODULE_INFO(depends, "tegra-camera");

MODULE_ALIAS("i2c:imx318");
MODULE_ALIAS("of:N*T*Csony,imx318");
MODULE_ALIAS("of:N*T*Csony,imx318C*");
